...
namespace ChessGame
{
    public class Board
    {
        ...
        public Board()
        {
            ...
            // White pieces
            board[0, 0] = new Rook(('a', 1), "white");
            board[0, 1] = new Knight(('b', 1), "white");
            board[0, 2] = new Bishop(('c', 1), "white");
            board[0, 3] = new Queen(('d', 1), "white");
            board[0, 4] = new King(('e', 1), "white");
            board[0, 5] = new Bishop(('f', 1), "white");
            board[0, 6] = new Knight(('g', 1), "white");
            board[0, 7] = new Rook(('h', 1), "white");
            board[1, 0] = new Pawn(('a', 2), "white");
            board[1, 1] = new Pawn(('b', 2), "white");
            board[1, 2] = new Pawn(('c', 2), "white");
            board[1, 3] = new Pawn(('d', 2), "white");
            board[1, 4] = new Pawn(('e', 2), "white");
            board[1, 5] = new Pawn(('f', 2), "white");
            board[1, 6] = new Pawn(('g', 2), "white");
            board[1, 7] = new Pawn(('h', 2), "white");

            // Black pieces
            board[7, 0] = new Rook(('a', 8), "black");
            board[7, 1] = new Knight(('b', 8), "black");
            board[7, 2] = new Bishop(('c', 8), "black");
            board[7, 3] = new Queen(('d', 8), "black");
            board[7, 4] = new King(('e', 8), "black");
            board[7, 5] = new Bishop(('f', 8), "black");
            board[7, 6] = new Knight(('g', 8), "black");
            board[7, 7] = new Rook(('h', 8), "black");
            board[6, 0] = new Pawn(('a', 7), "black");
            board[6, 1] = new Pawn(('b', 7), "black");
            board[6, 2] = new Pawn(('c', 7), "black");
            board[6, 3] = new Pawn(('d', 7), "black");
            board[6, 4] = new Pawn(('e', 7), "black");
            board[6, 5] = new Pawn(('f', 7), "black");
            board[6, 6] = new Pawn(('g', 7), "black");
            board[6, 7] = new Pawn(('h', 7), "black");
        }
        ...
        */
        {
            ...
            try
            {
                currentPiece = GetPiece(currentPosition); //OK
        ...
        */
        {
            ...
            {
                Piece piece = (Piece)board[lineInt, columInt];
                return piece;
            }
